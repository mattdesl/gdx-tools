...
public class MultiTexTest2 implements ApplicationListener {

	public static void main(String[] args) {
		new LwjglApplication(new MultiTexTest2(), "Test", 640, 480, true);
	}
	...
	@Override
	public void create() {		
		tex0 = new Texture(Gdx.files.internal("data/test.png"));
